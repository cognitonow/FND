...
export default function NewArticlePage({ addLog }: NewArticlePageProps) {
        ...
        <div className="lg:col-span-2">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Write your article here. You can use markdown for formatting.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
